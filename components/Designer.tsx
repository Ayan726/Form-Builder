...
const Designer = () => {
  ...
  useDndMonitor({
    onDragEnd: (event: DragEndEvent) => {
      ...
      const droppingDesignerBtnOverDesignerDropArea =
        isDesignerBtnElement && isDroppingOverDesignerDropArea;

      // first scenario
      if (droppingDesignerBtnOverDesignerDropArea) {
...
function DesignerElementWrapper({ element }: { element: FormElementInstance }) {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "flex w-full items-center h-[120px] rounded-md bg-accent/40 px-4 py-2 pointer-events-none opacity-100",
